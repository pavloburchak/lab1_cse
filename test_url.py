...
class TestLab1(unittest.TestCase):
    ...
    def test_download_mp3(self):
        link1 = "https://res.cloudinary.com/hvldskieo/raw/upload/v1521464696/01\
        _Stuck_on_the_puzzle_intro_osli5a.mp3"
        link2 = "https://res.cloudinary.com/hvldskieo/raw/upload/v1521464696/01\
        _Stuck_on_the_puzzle_intro_osli5a"
        self.assertEqual(url.download_mp3(link1, 2017), "01_Stuck_on_the_puzzl\
        e_intro_osli5a.mp3")
